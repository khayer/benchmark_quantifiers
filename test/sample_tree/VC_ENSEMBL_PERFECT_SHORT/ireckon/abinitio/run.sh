...
java -Xmx15000M -jar /home/hayer/itmat/benchmark_quantifiers/tools/IReckon-1.0.8.jar test/sample_tree/VC_ENSEMBL_PERFECT_SHORT/VC.ENS.PS.s.bam tmp_genome_fa tmp_ireckon_ucsc -1 test/sample_tree/reads/VC.ENS.PS_fwd.fq -2 test/sample_tree/reads/VC.ENS.PS_rev.fq -o . -n 10 -b 0 -novel 1
